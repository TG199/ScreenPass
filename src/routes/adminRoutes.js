...
router.put('/admin/movies/update-movie/:id', authMiddleware, isAdmin, AdminController.updateMovie);
router.delete('/movies/delete-movie/:id', authMiddleware, isAdmin, AdminController.deleteMovie);
